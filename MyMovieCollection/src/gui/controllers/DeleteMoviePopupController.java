    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            for (Movie movie:allMovies) {
                ...
                long daysBetween = Duration.between(lastView.atTime(0, 0),
                        timeNow.atTime(0, 0)).toDays();
                if (Integer.parseInt(String.valueOf(movie.getPersonalRating()
                        .charAt(movie.getPersonalRating().length()-1)))
                        < 6 && daysBetween > 730) {
